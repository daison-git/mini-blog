...
2. ClassLoader::registerDir()の呼び出し
    - カレントディレクトリに /mvc を付加したパスと /models を付加したパスを作成
    - 上記を引数問sて ClassLoaderクラス の registerDir() を呼び出す
...
$ClassLoader->registerDir(dirname(__FILE__) . '/core'); // coreディレクトリを登録

$ClassLoader->registerDir(dirname(__FILE__) . '/models'); // models ディレクトリを登録
